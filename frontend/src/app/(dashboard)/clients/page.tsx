                ...
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="p-2 rounded-xl text-text-secondary hover:text-indigo-600 hover:bg-indigo-500/15 transition-colors shadow-sm"
                      title="Edit client"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl text-text-secondary hover:text-red-600 hover:bg-red-500/15 transition-colors shadow-sm"
                      title="Delete client"
                    >
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
